...
function FreeSpinBeginSplashUI:Init()
    ...
    self.goAliceFeatureTip = self.m_transform:FindDeepChild("AliceFeatureTip").gameObject
    self.goCatFeatureTip = self.m_transform:FindDeepChild("CatFeatureTip").gameObject
    self.goX3FeatureTip = self.m_transform:FindDeepChild("X3FeatureTip").gameObject
end 
...
function FreeSpinBeginSplashUI:Show()
    ...
    self.goAliceFeatureTip:SetActive(false)
    self.goCatFeatureTip:SetActive(false)
    self.goX3FeatureTip:SetActive(false)
    if AliceFunc.nPickQueenFeature == 1 then
        self.goX3FeatureTip:SetActive(true)
    elseif AliceFunc.nPickQueenFeature == 2 then
        self.goCatFeatureTip:SetActive(true)
    elseif AliceFunc.nPickQueenFeature == 3 then
        self.goAliceFeatureTip:SetActive(true)
    end
...
function FreeSpinBeginSplashUI:Hide()
    ...
    AliceLevelUI:PlayFreeSpinBeginHideAni()
