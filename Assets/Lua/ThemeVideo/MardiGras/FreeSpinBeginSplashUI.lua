...
function FreeSpinBeginSplashUI:Init()
    ...
    self.textTextMeshProCoins = self.m_transform:FindDeepChild("TextMeshProCoins"):GetComponent(typeof(TextMeshProUGUI))
...
function FreeSpinBeginSplashUI:Show()
    ...
    MardiGrasLevelUI:UpdateTotalWinToUI(fAddMoneyCount, 2.0)
    self.textTextMeshProCoins.text = "$"..MoneyFormatHelper.numWithCommas(fAddMoneyCount)
end
...
function FreeSpinBeginSplashUI:Hide()
    ...
    MardiGrasLevelUI:PlayFreeSpinBeginHideAni()
end
