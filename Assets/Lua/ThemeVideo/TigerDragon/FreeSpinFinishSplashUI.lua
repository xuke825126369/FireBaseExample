...
function FreeSpinFinishSplashUI:Init()
    ...
    self.m_textMeshProFreeSpinNum = self.m_transform:FindDeepChild("TextMeshProFreeNum"):GetComponent(typeof(TextMeshProUGUI))
    self.m_textMeshProWinCoins  = self.m_transform:FindDeepChild("TextMeshProWinCoins"):GetComponent(typeof(TextMeshProUGUI))
