...
ChutesRocketsSendSpinPop = {}

function ChutesRocketsSendSpinPop:Show(count)
    if self.transform.gameObject == nil then
        local strPath = "Assets/ActiveNeedLoad/ChutesRockets/ChutesRocketsSendSpinPop.prefab"
...
function ChutesRocketsSendSpinPop:onKeepBtnClick()
    ViewScaleAni:Hide(self.transform.gameObject)
end

function ChutesRocketsSendSpinPop:OnDestroy()
