RocketFortuneMoreSpinPop = {}

function RocketFortuneMoreSpinPop:Show(parentTransform)
    if self.transform.gameObject == nil then
        local strPath = "Assets/ActiveNeedLoad/RocketFortune/RocketFortuneMoreSpinPop.prefab"
...
function RocketFortuneMoreSpinPop:onCloseBtnClicked()
    --TODO 关闭音效
    self.popController:hide(true)
    RocketFortuneMainUIPop.popController:hide()
...
function RocketFortuneMoreSpinPop:onKeepBtnClick()
...
function RocketFortuneMoreSpinPop:OnDestroy()
