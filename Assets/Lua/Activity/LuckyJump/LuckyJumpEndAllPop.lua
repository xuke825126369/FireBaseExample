LuckyJumpEndAllPop = {} --包括两个界面，一个是转盘，一个是活动游戏界面

function LuckyJumpEndAllPop:Show()
    if self.transform.gameObject == nil then
        local path = "Assets/LuckyJump/LuckyJumpEndAllPop.prefab"
    ...
    self.m_txtCoinsWin.text = MoneyFormatHelper.numWithCommas(LuckyJumpDataHandler.m_mapPrize["All"])
    self.transform.gameObject:SetActive(true)
    self.transform:SetAsLastSibling()
end

function LuckyJumpEndAllPop:onCollectBtnClicked()
