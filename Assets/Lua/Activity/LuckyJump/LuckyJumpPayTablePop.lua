LuckyJumpPayTablePop = {} --包括两个界面，一个是转盘，一个是活动游戏界面

function LuckyJumpPayTablePop:Show()
    if self.transform.gameObject == nil then
        local path = "Assets/LuckyJump/LuckyJumpPayTablePop.prefab"
...
function LuckyJumpPayTablePop:onCloseBtnClicked()
    --TODO 显示退出动画
