...
StairWaySalesShopPop = {}

StairWaySalesShopPop.gameObject = nil
StairWaySalesShopPop.transform = nil
StairWaySalesShopPop.fullLoadingGameObject = nil

local yield_return = (require 'cs_coroutine').yield_return

local data = 0

function StairWaySalesShopPop:isActiveShow()
    return self.gameObject and self.gameObject.activeInHierarchy
end

function StairWaySalesShopPop:createAndShow(bIsInQueue)
    --查看是否有促销活动
    ...
    if(bLandscape ~= self.bLandscape) then
        ...
        if bLandscape then
            self.gameObject = Unity.Object.Instantiate(Util.getHotPrefab("Assets/BaseHotAdd/RocketsSalesShop/StairWaySalesShopPop.prefab"))
        else
            self.gameObject = Unity.Object.Instantiate(Util.getHotPrefab("Assets/BaseHotAdd/RocketsSalesShop/StairWaySalesShopPopPortrait.prefab"))
        end
...
function StairWaySalesShopPop:refreshContent()
...
function StairWaySalesShopPop:Start()
...
function StairWaySalesShopPop:OnEnable()
    NotificationHandler:addObserver(self, "onPurchaseDoneNotifycation")
    NotificationHandler:addObserver(self, "onPurchaseFailedNotifycation")
end

function StairWaySalesShopPop:OnDisable()
    NotificationHandler:removeObserver(self)
end

function StairWaySalesShopPop:onCloseBtnClicked()
...
function StairWaySalesShopPop:onPurchaseDoneNotifycation()
    self:hideLoading()
    --TODO 更新下一个button
...
function StairWaySalesShopPop:onPurchaseFailedNotifycation()
    self:hideLoading()
    CommonDialogBox:ShowSureUI("Purchase Failed")
end

function StairWaySalesShopPop:showLoading()
	self.fullLoadingGameObject:SetActive(true)
end

function StairWaySalesShopPop:hideLoading()
	self.fullLoadingGameObject:SetActive(false)
end

function StairWaySalesShopPop:getShopSkus()
    ...
    local listShopSkus = {"com.slots.goldfever.coins001", "com.slots.goldfever.coins001",
                        "com.slots.goldfever.coins001"}
    if nType == 1 then
        listShopSkus = {"com.slots.goldfever.coins001", "com.slots.goldfever.coins001",
                        "com.slots.goldfever.coins001"}
    elseif nType == 2 then
        listShopSkus = {"com.slots.goldfever.coins004", "com.slots.goldfever.coins004",
                        "com.slots.goldfever.coins004"}
    elseif nType == 3 then
        listShopSkus = {"com.slots.goldfever.coins007", "com.slots.goldfever.coins007",
                        "com.slots.goldfever.coins007"}
    elseif nType == 4 then
        listShopSkus = {"com.slots.goldfever.coins010", "com.slots.goldfever.coins010",
                        "com.slots.goldfever.coins010"}
    elseif nType == 5 then
        listShopSkus = {"com.slots.goldfever.coins050", "com.slots.goldfever.coins050",
...
function StairWaySalesShopPop:updateLeftTime()
...
function StairWaySalesShopPop:setCardsContainer(parent, skuInfo)
