...
public class CustomerSpineAnimatorMasked : CustomerRectMaskGroupChildren
{
    [SerializeField]
    ...
    private void Init()
    {
        if (!orInit())
        {
            SkeletonAnimator m_skeletonAnimation = GetComponent<SkeletonAnimator>();
    ...
    private Material[] GetSpineAtlasMaterials(SkeletonAnimator m_skeletonAnimation)
    {
